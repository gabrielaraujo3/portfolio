  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[950px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a full-stack developer specializing in building exceptional experiencies. Currently, I'm focused on building responsive full-stack web applications.</p>
        <div>
